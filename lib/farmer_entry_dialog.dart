...
// class FarmerEntryDialog extends ConsumerStatefulWidget {
//   const FarmerEntryDialog({super.key});

//   @override
//   ConsumerState<FarmerEntryDialog> createState() => _FarmerEntryDialogState();
// }

// class _FarmerEntryDialogState extends ConsumerState<FarmerEntryDialog> {
...
//                       Farmer farmer = Farmer(firstName: firstName, middleName: secondName, lastName: thirdName, phone: phoneNumber, gender: selectedGender!, nida: nida!, dob: dob, zone: selectedZone!, ward: ward, village: village, accountNumber: accountNumber, bankName: bankName, farmSize: farmSize, numberOfTrees: numberOfTrees, numberOfTreesWithFruits: numberOfTreesWithFruits)

//                       final reference = await showDialog(
//                         context: context,
//                         builder: (context) => FutureProgressDialog(
//                           ref.read(farmerProvider.notifier).addFarmer(data),
