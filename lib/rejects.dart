...
import 'package:ratek/providers/reject_provider.dart';
import 'package:ratek/widgets/reject_sale_enrty_dialog.dart';

class RejectSalesScreen extends ConsumerStatefulWidget {
  const RejectSalesScreen({super.key});

  @override
  ConsumerState<RejectSalesScreen> createState() => _RejectSalesScreenState();
}

class _RejectSalesScreenState extends ConsumerState<RejectSalesScreen> {
